  ...
  return (
    <div className="flex justify-center items-center">
      ...
      <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center w-full sm:w-auto">
        ...
        <Button
          size="lg"
          className="rounded-full px-6 sm:px-8 md:px-10 py-5 sm:py-6 md:py-7 text-base sm:text-lg md:text-xl font-semibold bg-[#fdff45] text-[#144723] hover:bg-[#fdff45] transition-all duration-300 shadow-[0_0_15px_rgba(138,234,124,0.3)] hover:shadow-[0_0_25px_rgba(138,234,124,0.5)]"
