          ...
          <div className="bg-white rounded-full p-1 flex">
            {navItems.map((item) => {
              ...
              return (
                <Link
                  key={item.name}
                  className={`text-md font-semibold px-4 py-2 rounded-full transition-colors flex items-center gap-1.5 ${
            ...
            <div className="flex flex-col items-center justify-start pt-10 h-full">
              {navItems.map((item) => {
                ...
                return (
                  <Link
                    key={item.name}
                    className={`text-xl font-semibold px-6 py-4 my-1 rounded-full transition-all duration-200 ease-in-out flex items-center gap-2 w-64 justify-center ${
