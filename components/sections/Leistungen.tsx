...
export default function Leistungen({ className }: LeistungenProps) {
  return (
    <section
      id="leistungen"
      className={`w-full min-h-screen md:h-[calc(100vh)] flex flex-col justify-center items-center relative ${className || ""}`}
    >
